"""v7.9: LFW real ×10 (was ×8 in v7.8). Init from v7.8. python AIGuard/train_v79.py"""
...
SPLITS       = BASE / "splits"
INIT_WEIGHTS = str(BASE / "shufflenet_v2_3class_v78.pth")
WEIGHTS_PATH = str(BASE / "shufflenet_v2_3class_v79.pth")
...
if __name__=="__main__":
    ...
    pd.DataFrame(rows,columns=["epoch","loss","acc","f1_macro","f1_real","f1_fake","f1_filter"]).to_csv(str(BASE/"results/v79_val_results.csv"),index=False)
