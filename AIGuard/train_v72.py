"""
v7.2: orig eye_enlarging × 4 + LFW eye_enlarging × 4 (domain-matched).

python build_v72_splits.py   # build split first
python AIGuard/train_v72.py
"""
...
WEIGHTS_PATH = str(BASE / "shufflenet_v2_3class_v72.pth")
...
if __name__ == "__main__":
    ...
    pd.DataFrame(rows, columns=["epoch","loss","acc","f1_macro","f1_real","f1_fake","f1_filter"]) \
      .to_csv(str(BASE / "results/v72_val_results.csv"), index=False)
    print("Results -> results/v72_val_results.csv")
